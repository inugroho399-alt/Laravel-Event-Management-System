<nav x-data="{ open: false }" class="bg-white/95 backdrop-blur-md border-b border-slate-200 sticky top-0 z-40 shadow-xs transition-all">
            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center group">
                        <x-application-logo class="block h-9 w-auto text-slate-900 group-hover:opacity-90 transition-opacity" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="inline-flex items-center px-3.5 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-semibold uppercase tracking-wider transition-colors shadow-sm">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
